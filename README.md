...
Substrate chains which have blocks with metadata versions below 14 don't provide enough information to decode their data. For those chains external
...
there is not enough information in substrate metadata to distinguish between interesting cases.
...
aware not only of address value, but also of its [ss58](https://docs.substrate.io/v3/advanced/ss58/) formatting rules.
